...
export default function Login() {
  ...
  // Hook do React Router para redirecionar o usuário entre telas
  const navigate = useNavigate();

  const handleLogin = (e) => {
    e.preventDefault(); // Evita que a página recarregue ao enviar o form
    
    // Aqui no futuro entrará a sua requisição Axios para o Backend (Django/Spring)
    console.log("Tentando logar com:", email);
    
    // Por enquanto, vamos apenas simular o login e mandar o usuário para o Dashboard
    navigate('/dashboard');
  };
